...
elseif(WIN32)
    # When the bootstrap launcher is enabled, ship its external dependency manifest
    # next to the binaries (bin/). The launcher reads this at runtime. Installed
    # before the NSIS packaging step below so it is part of the payload.
    ...
    install(CODE "set(QGC_WINDOWS_BOOTSTRAP ${QGC_WINDOWS_BOOTSTRAP})")
